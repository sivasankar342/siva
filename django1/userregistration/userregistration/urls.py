...
urlpatterns = [
    ...
    path('', views.signup_page, name='signup'),    # URL for signup page
    path('login/', views.login_page, name='login'),   # URL for login page
    path('home/', views.home_page, name='home'),    # URL for home page
    path('logout/', views.logout_page, name='logout'),  # URL for logout page
]
